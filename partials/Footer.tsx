    ...
    return (
        <footer className="footer bg-theme-light/50">
            <div className="container">
                <div className="row gx-5 pb-10 pt-[52px]">
                    ...
                    <div className="col-12 mt-12 md:col-6 lg:col-3">
                        ...
                        <p>1118 Thornridge Cir. Syracuse, Connecticut 15624</p>
                        <p>(104) 555-0127</p>
                    </div>
                </div>
            </div>
            <div className="container max-w-[1440px]">
                ...
                >
                    <p>Designed And Developed by <a href="https://github.com/shubhamkourav" target="_blank">Shubham Kumar</a></p>
                </div>
            </div>
        </footer>
    )
