            ...
            <div className="container">
                ...
                <div className="row mt-12 justify-center">
                    <div className="lg:col-10">
                        <div className="row">
                            {
                                members.peoples.map((people, i) => {
                                    const { image, name, position, social_media } = people;
                                    return (
                                        <div key={i} className="mb-6 flex flex-col px-6 text-center sm:col-6 lg:col-4 sm:items-center">
                                            ...
                                            <div
                                                className="mt-6 w-full flex-1 rounded-xl bg-white py-8 px-4 shadow-lg"
                                            >
                                                <h5 className="font-primary">{name}</h5>
                                                <p className="mt-1.5">{position}</p>
                                                <div className='flex mt-4 px-4 justify-evenly'>
                                                    {social_media.twitter ? <Link className='bg-theme-light/50 p-3 rounded-full' href={`https://x.com/${social_media.twitter}`}>
                                                        <svg
                                                            width="19"
                                                            height="15"
                                                            viewBox="0 0 19 15"
                                                    ...
                                                    {social_media.linkedin ? <Link className='bg-theme-light/50 p-3 rounded-full' href={`https://linkedin.com/${social_media.linkedin}`}>
                                                        <svg
                                                            width="19"
                                                            height="16"
                                                            viewBox="0 0 19 16"
                                                    ...
                                                    {social_media.skype ? <Link className='bg-theme-light/50 p-3 rounded-full' href={`https://skype.com/${social_media.skype}`}>
                                                        <svg
                                                            width="19"
                                                            height="18"
                                                            viewBox="0 0 17 18"
