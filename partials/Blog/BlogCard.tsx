...
const BlogCard: React.FC<BlogCardProps> = React.memo(function BlogCard({ title, category, date, image, short_description, link, time_text, featured_post = false }) {
    
    return (
        <div className={`mb-8 md:col-6 ${!featured_post ? 'lg:col-4': ''}`}>
            <div className="card">
                <img
                    className="card-img"
                ...
                <div className="card-content">
                    {category ? <div className="card-tags">
                    ...
                    <div className="card-footer mt-6 flex space-x-4">
                        <span className="inline-flex items-center text-xs text-[#666]">
                            ...
                            {moment(date).format('Mo MMM YYYY')}
                        </span>
                        <span className="inline-flex items-center text-xs text-[#666]">
                            <svg
                                className="mr-1.5"
